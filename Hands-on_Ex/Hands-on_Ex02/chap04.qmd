...
# First-order Spatial Point Patterns Analysis Methods {.course-chapter-title}
...
## How I Think About the Method Choices
...
```{r}
#| label: course-chap04-clean-mpsz
#| eval: false
mpsz_cl <- mpsz_sf %>%
  filter(SUBZONE_N != "SOUTHERN GROUP",
         PLN_AREA_N != "WESTERN ISLANDS",
...
```{r}
#| label: course-chap04-read-childcare
#| eval: false
...
```{r}
#| label: course-chap04-map-childcare-view
#| eval: false
tmap_mode('view')
tm_shape(childcare_sf)+
  tm_dots()
...
```{r}
#| label: course-chap04-ce-clustered
#| eval: false
...
```{r}
#| label: course-chap04-ce-montecarlo
#| eval: false
clarkevans.test(childcareSG_ppp,
                correction="none",
                clipregion= sg_owin,
...
::: callout-tip
### My finding from the bandwidth comparison
...
::: callout-note
### My reading of the kernel plots
...
::: callout-note
### Comparing local point patterns
...
## Beyond the Basic Density Surface
...
::: {.callout-tip}
## Beyond the Code: Bandwidth Changes the Story
